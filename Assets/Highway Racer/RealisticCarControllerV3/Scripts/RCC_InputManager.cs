...
public class RCC_InputManager {
    ...
    public delegate void onHighBeamHeadlights(bool state);
    ...
    public static RCC_Inputs GetInputs() {
        ...
        if (inputActions == null) {
            ...
            inputActions.Vehicle.HighBeamLights.canceled += HighBeamLights_canceled;
    ...
    private static void HighBeamLights_performed(InputAction.CallbackContext obj) {
        ...
        if (OnHighBeamHeadlights != null)
            OnHighBeamHeadlights(true);

    }

    private static void HighBeamLights_canceled(InputAction.CallbackContext obj) {

        if (OnHighBeamHeadlights != null)
            OnHighBeamHeadlights(false);
